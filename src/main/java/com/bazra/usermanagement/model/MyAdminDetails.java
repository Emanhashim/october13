...
public class MyAdminDetails implements UserDetails {
	...
	public MyAdminDetails(AdminInfo userInfo, UserAuthentication userAuthentication, UserCredential userCredential) {
		this.userAuthentication = userAuthentication;
		this.userCredential = userCredential;
	...
	public MyAdminDetails(UserCredential userCredential) {
		this.userCredential = userCredential;
	}
